...
//     fs::File selfStatusFile_f;
//     mem::Block fileBuffer_f;
//     Info info_f;
//
// private:  // constructors
//     MemoryReader(fs::File&& memInfoFile, fs::File&& selfStatusFile, const mem::Block& fileBuffer) :
...
//
//         const Result<SizeBytes, fs::File::Error> readResult = this->selfStatusFile_f.read_into(this->fileBuffer_f);
//         if (readResult.is_failure()) {
//             return SimpleResult<MemoryReader::Error>::failure_by_copy(MemoryReader::Error::FILE_READ_ERROR);
//         }
//         const SizeBytes bytesRead = readResult.success_value_or_panic();
...
//         CONTRACTS_ASSERT(fs::File::exists(SELF_STATUS_PATH));
//
...
//         }
//
//         fs::File selfStatusFile{SELF_STATUS_PATH};
//
//         const fs::File::SimpleResult selfStatusOpenResult = selfStatusFile.open(fs::FileMode::READ_ONLY, false);
